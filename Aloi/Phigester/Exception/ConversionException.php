...
/**
 * A ConversionException indicates that a call to Aloi_Phigester_ConvertUtils->convert()
 ...
 * @version $Id$
 */
class Aloi_Phigester_Exception_ConversionException extends Exception {
}
?>
