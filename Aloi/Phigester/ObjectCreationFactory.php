...
/**
 * Interface for use with Aloi_Phigester_FactoryCreateRule.
 * 
 ...
 * @version $Id$
 */
interface Aloi_Phigester_ObjectCreationFactory {
  /**
   * Factory method call by Aloi_Phigester_FactoryCreateRule to supply an object
